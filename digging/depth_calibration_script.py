...
This script sets all of the parameters of the depth stepper motor.
...
if __name__ == '__main__':
    depth_tic_port = '/dev/ttyACM0' #Port of depth tic36v4 stepper driver
    depth_tic_serial_num = '00320097' #Depth tic36v4 stepper driver serial number

    setter = serial.Serial(port=depth_tic_port, baudrate=9600, timeout=.1)
