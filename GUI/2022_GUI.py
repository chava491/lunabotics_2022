...
#        self.main = Robot()
    ...
    def setupUi(self, Dialog):
        ...
        self.label_AC.setGeometry(QtCore.QRect(1130, 10, 151, 31))
        self.label_AC.setFont(font)
        self.label_AC.setObjectName("label_AC")
        #Subsystem header Autonomy
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(1130, 80, 81, 16))
        self.label_2.setObjectName("label_2")
        #Subsystem header Manual
        ...
        self.label_6.setGeometry(QtCore.QRect(880, 110, 55, 16))
        ...
        self.label_12.setGeometry(QtCore.QRect(260, 185, 71, 16))
        ...
        self.line_2.setGeometry(QtCore.QRect(0, 290, 1301, 16))
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.line_3 = QtWidgets.QFrame(Dialog)
        self.line_3.setGeometry(QtCore.QRect(1100, 10, 20, 281))
        self.line_3.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.line_4 = QtWidgets.QFrame(Dialog)
        self.line_4.setGeometry(QtCore.QRect(1120, 90, 161, 16))
        self.line_4.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.line_5 = QtWidgets.QFrame(Dialog)
        self.line_5.setGeometry(QtCore.QRect(10, 90, 1100, 16))
        ...
        self.line_7.setGeometry(QtCore.QRect(670, 110, 20, 181))
        self.line_7.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_7.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_7.setObjectName("line_7")
        self.line_8 = QtWidgets.QFrame(Dialog)
        self.line_8.setGeometry(QtCore.QRect(10, 120, 1100, 16))
        ...
        self.Feedback.setGeometry(QtCore.QRect(970, 340, 321, 261))
        self.Feedback.setObjectName("Feedback")
        self.check_Data = QtWidgets.QCheckBox(Dialog)
        self.check_Data.setGeometry(QtCore.QRect(125, 315, 21, 20))
        ...
        self.AC_On.setGeometry(QtCore.QRect(1130, 50, 141, 20))
        ...
        self.A_Dumping.setGeometry(QtCore.QRect(1130, 110, 95, 20))
        ...
        self.A_Locomotion.setGeometry(QtCore.QRect(1130, 140, 95, 20))
        ...
        self.A_Digging.setGeometry(QtCore.QRect(1130, 170, 95, 20))
        ...
        self.Initiate_A.setGeometry(QtCore.QRect(1160, 210, 93, 28))
        ...
        self.Loco_Right.setGeometry(QtCore.QRect(160, 190, 51, 28))
        ...
        self.Loco_FW.setGeometry(QtCore.QRect(85, 150, 61, 28))
        self.Loco_FW.setObjectName("Loco_FW")
        self.Loco_FW.clicked.connect(self.forward_loco)

        self.Loco_Back = QtWidgets.QPushButton(Dialog)
        self.Loco_Back.setGeometry(QtCore.QRect(90, 230, 51, 28))
        ...
        self.Loco_Left.setGeometry(QtCore.QRect(20, 190, 51, 28))
        ...
        self.Loco_stop.setGeometry(QtCore.QRect(90, 190, 51, 28))
        ...
        self.Pitch_stop.setGeometry(QtCore.QRect(550, 180, 100, 28))
        ...
        self.Dig_DeH.setGeometry(QtCore.QRect(440, 220, 100, 28))
        ...
        self.Dig_InH.setGeometry(QtCore.QRect(330, 220, 100, 28))
        ...
        self.Depth_Stop.setGeometry(QtCore.QRect(550, 220, 100, 28))
    ...
    def depth_increase(self):
        ...
        # print("This is for increasing depth")

    def depth_decrease(self):
        self.publish_data_manual(None, 10)
        # print("This is for decreasing depth")
    ...
    #
    # Might need to be revised due to new design choices for 2022 build.
    # --------------------------------------------------------------------
    def dump_handler(self):
        self.publish_data_manual(None, 24)
        # print("This is for dumping actuator forward/extend")

    def dump_retract(self):
        self.publish_data_manual(None, 25)
        # print("This is for dumping actuator backward/retract")

    def dump_stop(self):
        self.publish_data_manual(None, 23)
        # print("This is for stop dumping/actuator")
    ...
    def setControl(self, b):
        if b.text() == "Active Manual Controls":
            self.Loco_Right.setEnabled(True)
            self.Loco_Back.setEnabled(True)
            self.Loco_Left.setEnabled(True)
            self.Loco_FW.setEnabled(True)
    ...
    # --------------------------------------------------------------------
    # Labeling of buttons on GUI
    #
    # Needs to be altered to remove the unnecessary buttons and titles due
    # to new robot designs for 2022.
    # --------------------------------------------------------------------
    def retranslateUi(self, Dialog):
        ...
        self.Dig_CCW.setText(_translate("Dialog", "Decrease Angle"))
        self.Dig_CW.setText(_translate("Dialog", "Increase Angle"))
        self.Dig_DeH.setText(_translate("Dialog", "Decrease "))
        self.Dig_InH.setText(_translate("Dialog", "Increase"))
        self.Loco_FW.setText(_translate("Dialog", "Forward"))
        self.Loco_Back.setText(_translate("Dialog", "Back"))
        self.Loco_Left.setText(_translate("Dialog", "Left"))
        self.label_7.setText(_translate("Dialog", "Auger"))
        ...
        self.label_11.setText(_translate("Dialog", "Linear Actuator"))
...
if __name__ == "__main__":
    ...
    #
    # rospy.on_shutdown(main_wrapper.big_red_button) # stop everything, closes UI
    #
